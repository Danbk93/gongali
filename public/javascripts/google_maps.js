          ...
          if (httpRequest.readyState == 4 && httpRequest.status == 200) {
            ...
            if (res.result == true) {
              ...
              for (var i = 0; i < res.data.length; i++) {
                ...
                input.setAttribute('onclick', 'call_detail(this)');
...
var call_detail = function(input_tag){
  var tag = input_tag.parentNode.parentNode.parentNode.parentNode;
  sessionStorage.setItem('Pname',tag.getElementsByClassName('Pname')[0].textContent);
  sessionStorage.setItem('Fname',tag.getElementsByClassName('Fname')[0].textContent);
