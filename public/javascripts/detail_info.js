...
var print_result = function(res){
    ...
    districts += "<tr><td>시설 유형: </td>" + "<td>"+ res.Paddress +"</td></tr>";  
    districts += "<tr><td>위치: </td>" + "<td>"+ res.Paddress +"</td></tr>";    
    districts += "<tr><td>휴관일: </td>" + "<td>"+ res.closed_date +"</td></tr>";
    ...
    if(res.isFree == 'Y') districts += "<tr><td>시간당 요금: </td>" + "<td>"+ res.base_charge_fee/res.base_usage_time + "</td></tr>"
